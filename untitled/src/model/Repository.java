...
public class Repository {
    ...
    static {
        ...
        cafeEspressolist.add(new MenuCategory("콜드브루", 3000, "샷추가",500,"all"));
        ...
        cafeLattelist.add(new MenuCategory("헤이즐넛라뗴", 3500, "저지방우유",500,"all"));
        cafeLattelist.add(new MenuCategory("녹차샷라떼", 3500, "저지방우유",500,"all"));
        cafeLattelist.add(new MenuCategory("바닐라라떼", 3500, "저지방우유",500,"all"));
        cafeLattelist.add(new MenuCategory("꿀라떼", 3500, "저지방우유",500,"all"));

        cafeSmoothielist = new ArrayList<>();
        cafeSmoothielist.add(new MenuCategory("밀크쉐이크", 5000, "초코칩추가",500,"ice"));
        cafeSmoothielist.add(new MenuCategory("딸기쉐이크", 5000, "초코칩추가",500,"ice"));
        cafeSmoothielist.add(new MenuCategory("초코쉐이크", 5000, "초코칩추가",500,"ice"));
        cafeSmoothielist.add(new MenuCategory("딸기스무디", 5000, "초코칩추가",500,"ice"));
        cafeSmoothielist.add(new MenuCategory("오레오초코프라페", 5000, "초코칩추가",500,"ice"));

        cafeAdelist = new ArrayList<>();
        cafeAdelist.add(new MenuCategory("유자티", 4500, "사이즈업",500,"all"));
        cafeAdelist.add(new MenuCategory("유자에이드", 4500, "사이즈업",500,"ice"));
        cafeAdelist.add(new MenuCategory("자몽티", 4500, "사이즈업",500,"all"));
        cafeAdelist.add(new MenuCategory("자몽에이드", 4500, "사이즈업",500,"ice"));
        cafeAdelist.add(new MenuCategory("오미자에이드", 4500, "사이즈업",500,"ice"));
