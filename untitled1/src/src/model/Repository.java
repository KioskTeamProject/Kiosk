...
public class Repository {
    ...
    static {
        ...
        allCafeMenuList.add((MenuCategory) cafeEspressolist);
        allCafeMenuList.add((MenuCategory) cafeLattelist);
        allCafeMenuList.add((MenuCategory) cafeSmoothielist);
        allCafeMenuList.add((MenuCategory) cafeAdelist);
