...
import static src.model.Manager.util.Utility.input;
import static src.model.Manager.util.Utility.makeLine;
...
//                System.out.println(strings); 모든 메뉴 네임들 불러옴
...
//                            user.menuCategories()
//
//                    System.out.println(cart); 메뉴이름 불러와서 있으면 확인하고 true
                    // 없으면 false 값 보내줌

//                    userCard.setOrderCoffe();
//                    System.out.println(userCard.getOrderCoffe());
                }
