...
public class Repository {
    ...
    public static List<MenuCategory> allCafeMenuList;
    ...
    static {
        ...
        allCafeMenuList = new ArrayList<>();
        allCafeMenuList.add(new MenuCategory(cafeEspressolist));
        allCafeMenuList.add(new MenuCategory(cafeLattelist));
        allCafeMenuList.add(new MenuCategory(cafeSmoothielist));
        allCafeMenuList.add(new MenuCategory(cafeAdelist));
